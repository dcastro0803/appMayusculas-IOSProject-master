//
//  TableViewControllerReglasMinuscula.swift
//  appMayusculas
//
...
class TableViewControllerReglasMinuscula: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.title = "Reglas Mayuscula"
        let pathReglas = Bundle.main.path(forResource: "ReglasMinusculas", ofType: "plist")
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let VistaDetalle = segue.destination as! ViewControllerDetallesMinuscula
